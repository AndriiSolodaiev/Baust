...
const config = {
  ...
  entry: {
    ...
    glampings: './src/assets/scripts/gulp-modules/glampings.js',
    saunas: './src/assets/scripts/gulp-modules/saunas.js',
    singleGlamping: './src/assets/scripts/gulp-modules/single-glamping.js',
    singleSauna: './src/assets/scripts/gulp-modules/single-sauna.js',
  },
  output: {
